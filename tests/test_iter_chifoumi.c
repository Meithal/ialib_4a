...
enum actions {PIERRE, PAPIER, CISEAUX};
enum rewards {REW_LOSS, REW_NEUTRAL, REW_WIN};

enum {nb_states = 3};
int actions[] = {PIERRE, PAPIER, CISEAUX};
...
static void test_iterative()
{
    ...
    //premiere manche
    (*transitions)[0][PIERRE][1][REW_LOSS] = 1.0; 
    (*transitions)[0][PAPIER][1][REW_LOSS] = 1.0;
    (*transitions)[0][CISEAUX][1][REW_LOSS] = 1.0;
    //deuxieme manche
    (*transitions)[1][PIERRE][2][REW_LOSS] = 1.0;
    (*transitions)[1][PAPIER][2][REW_LOSS] = 1.0;
    (*transitions)[1][CISEAUX][2][REW_LOSS] = 1.0;
